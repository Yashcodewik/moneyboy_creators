        ...
        <p className="post-text">
          {post?.text ? (
            <>
              ...
              {post.text.length > 150 && (<span className="active-down-effect-2x post-more" onClick={() => setExpanded(!expanded)}>{expanded ? " less" : " more"}</span>)}
            </>
          ) : (
      ...
      <div className="moneyboy-post__media">
        ...
        <div className="moneyboy-post__actions">
          ...
          <ul>
            ...
            {/* Save */}
            <li>
              <Link href="#" className={`post-save-btn ${post.isSaved ? "active" : ""}`} onClick={(e) => {e.preventDefault(); onSave(post._id); }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
