  ...
  return (
    <div className="moneyboy-post__container card">
      <div className="moneyboy-post__header">
            ...
            <div className="profile-card__avatar-settings">
              <div className="profile-card__avatar">
                <img
                  ...
                  src="https://res.cloudinary.com/drhj03nvv/image/upload/v1768307520/profile/1768307518783-post-img-13.jpg.jpg"
                />
              </div>
            </div>
        ...
        <div className="moneyboy-post__upload-more-info">
          ...
          <div
            ...
            data-more-actions-toggle-element="true"
          >
      ...
      <div className="moneyboy-post__desc">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vel erat
          non mauris convallis vehicula. Nulla et sapien. Integer tortor tellus,
          aliquam...
      ...
      <div className="moneyboy-post__media">
        <div className="moneyboy-post__img">
          <img
            ...
            src="https://res.cloudinary.com/drhj03nvv/image/upload/v1768558816/posts/thumbnail/1768558810830-post-img-2.png.png"
          />
        </div>
