...
//               <button className={`page-content-type-button active-down-effect ${activeTab === (isLoggedIn ? "following" : "discover") ? "active" : ""}`}onClick={() =>handleTabClick(isLoggedIn ? "following" : "discover")}>
...
//               {activeTab === "feed" && (
//                 <InfiniteScrollWrapper dataLength={posts.length} fetchMore={fetchPosts} hasMore={hasMore} scrollableTarget="feedScrollableDiv">
//                   <div className="moneyboy-posts-wrapper">
...
//               )}
//               {activeTab === "following" && (
//                   <InfiniteScrollWrapper dataLength={followingPosts.length} fetchMore={fetchFollowingPosts} hasMore={followingHasMore} scrollableTarget="feedScrollableDiv" >
//                     <div className="moneyboy-posts-wrapper">
...
//               {activeTab === "popular" && (
//                   <InfiniteScrollWrapper dataLength={popularPosts.length} fetchMore={fetchPopularPosts} hasMore={popularHasMore} scrollableTarget="feedScrollableDiv" >
//                     <div className="moneyboy-posts-wrapper">
