...
const ForgotPassword = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      ...
      try {
        // STEP 1 → Send OTP
        if (!otpVerified && !showChangePassword) {
            ...
            {!showChangePassword && (
              <div className="moneyboy-post__container card">
                ...
                <div className="form_grid">
                  ...
                  <div className="recaptcha one">Add Recaptcha</div>
                </div>
                ...
                <div className="form_grid">
                  <div className="one">
                    <div className="label-input password">
                      ...
                      >
                        <i
                          className={`icons ${showPass ? "eye" : "eye-slash"} svg-icon`}
                        ></i>
                      </span>
                    </div>
                  ...
                  <div className="one">
                    <div className="label-input password">
                      ...
                      >
                        <i
                          className={`icons ${showConfirmPass ? "eye" : "eye-slash"} svg-icon`}
                        ></i>
                      </span>
                    </div>
