      ...
      <div className="moneyboy-2x-1x-layout-container">
        <div className="moneyboy-2x-1x-a-layout wishlist-page-container">
          ...
          <div className="moneyboy-feed-page-cate-buttons card" id="posts-tabs-btn-card">
            <button className="cate-back-btn active-down-effect hide_mobail"><span className="icons arrowLeft"></span></button>
            <button className="page-content-type-button active-down-effect active">Basic information</button>
            <button className="page-content-type-button active-down-effect">Pricing settings</button>
            <button className="page-content-type-button active-down-effect">Account and security</button>
          </div>
            ...
            <div className="creator-profile-front-content-container">
              ...
              <div className="creator-profile-card-container card">
                <div className="creator-profile-banner">
                  <img src="/images/profile-banners/profile-banner-2.jpg" alt="Creator Profile Banner Image" />
                ...
                <div className="creator-profile-info-container">
                  ...
                  <div className="creator-subscriptions-container">
                    <div className="form_grid">
                      ...
                      <CustomSelect label="Select Your Gender" icon={<svg className="icons groupUser svg-icon" />}
                        options={[
                      ...
                      <div className="btm_btn one">
                        <button className="premium-btn active-down-effect"><span>Update Profile</span></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="creator-profile-card-container">
                ...
                <div className="subtop_cont">
                  <h3>Subscription</h3>
                  <button className="btn-primary"><GoDotFill size={20}/> <span>Paid Subscriptions</span></button>
                </div>
                <div className="accordion">
                  <div className="accordion_head">
                    <div className="head_cont">
                    <span>Monthly Subscription Price<span className="star">*</span></span>
                    <p>9.99</p>
                    </div>
                ...
                <p className="worn_text">User can <b>9 Days</b> of free subscription before subscribe to a subscription.</p>
                <div className="accordion">
                  <div className="accordion_head">
                    <div className="head_cont">
                    <span>Yearly Subscription Price<span className="star">*</span></span>
                    <p>9.99</p>
                    </div>
                    <svg className="icons chevronDownRounded"/>
                  </div>
                ...
                <div className="accordion">
                  <div className="accordion_head">
                    <div className="head_cont">
                    <span>PPV Request - Custom video<span className="star">*</span></span>
                    <p>9.99</p>
                    </div>
                    <svg className="icons chevronDownRounded"/>
                  </div>
                ...
                <div className="accordion">
                  <div className="accordion_head">
                    <div className="head_cont">
                    <span>PPV Request - Custom Photo<span className="star">*</span></span>
                    <p>9.99</p>
                    </div>
                    <svg className="icons chevronDownRounded"/>
                  </div>
                ...
                <div className="btm_btn">
                  <button className="premium-btn active-down-effect"><span>Save Changes</span></button>
                </div>
                </div>
                </div>
              </div>
                ...
                <div className="card filters-card-wrapper">
                 ...
                 <div className="form_grid">
                  <div className="label-input one">
                    ...
                    <input type="text" placeholder="coreybergson@email.com"/>
