                                    ...
                                    <Link href="#" className="profile-card__main">
                                      ...
                                      <div className="profile-card__info">
                                        ...
                                        <div className="profile-card__username">
                                          ...
                                          <span className="badge gray">{txn.paymentMethod || "card"}</span>
                                          {txn.status === "PENDING" && (
                                ...
                                <div className="date_box">
                                  <div className="date_wrap">
                                    ...
                                    <div className="containt">
                                      <span>Amount</span>
                                      <p className={isIncoming ? "text-green" : ""}>${txn.amount}</p>
                                    </div>
                                  </div>
                                  <div className="date_wrap">
                            ...
                            <div className="detailsbox_wrap">
                              <div className="date_box">
                                <div className="date_wrap mobail_hide">
                                  ...
                                  <div className="containt">
                                    <span>Product Type</span>
                                    <p>{selectedTransaction?.type?.toLowerCase().replace("_", " ")}</p>
                                  </div>
                                </div>
                            ...
                            <div className="rel-user-desc">
                              <div>
                                ...
                                {selectedTransaction?.type === "TIP" ? (
                                  <p>Tip given to @ {selectedTransaction?.toUser?.displayName}</p>
                                ) : selectedTransaction?.type ===
                                  "SUBSCRIPTION" ? (
                                  <p> Subscription purchased by @ {selectedTransaction?.fromUser?.displayName}</p>
                                ) : (
                                  <p>Product purchased by @ {selectedTransaction?.fromUser?.displayName}</p>
                                )}
                              </div>
                            </div>
                          </div>
