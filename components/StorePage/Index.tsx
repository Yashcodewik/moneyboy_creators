...
import { ShoppingCart, ChartNoAxesCombined, ChevronLeft, ChevronRight, X, Sparkles, Image, Video, Flame, FlameIcon, PlayCircle,} from "lucide-react";
  ...
  return (
                          ...
                          <div className="creator-media-card card">
                            <div className="creator-media-card__media-wrapper">
                              <div className="creator-media-card__media">
                                <img alt="Post Image" src="/images/post-images/post-img-1.png" />
                ...
                <div className="discovery-page-content-wrapper mt-0">
                  <div className="discovery-page-cards-layouts">
                          ...
                          <div className="user-profile-card__info-container">
                            ...
                            <div className="user-profile-card__wishlist-btn">
                              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                <path d="M14.7666 1.66687H6.73327C4.95827 1.66687 3.5166 3.11687 3.5166 4.88354V16.6252C3.5166 18.1252 4.5916 18.7585 5.90827 18.0335L9.97494 15.7752C10.4083 15.5335 11.1083 15.5335 11.5333 15.7752L15.5999 18.0335C16.9166 18.7669 17.9916 18.1335 17.9916 16.6252V4.88354C17.9833 3.11687 16.5416 1.66687 14.7666 1.66687Z" stroke="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M14.7666 1.66687H6.73327C4.95827 1.66687 3.5166 3.11687 3.5166 4.88354V16.6252C3.5166 18.1252 4.5916 18.7585 5.90827 18.0335L9.97494 15.7752C10.4083 15.5335 11.1083 15.5335 11.5333 15.7752L15.5999 18.0335C16.9166 18.7669 17.9916 18.1335 17.9916 16.6252V4.88354C17.9833 3.11687 16.5416 1.66687 14.7666 1.66687Z" stroke="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M8.4585 7.5415C9.94183 8.08317 11.5585 8.08317 13.0418 7.5415" stroke="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                              </svg>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="user-profile-card-wrapper">
                      <div className="user-profile-card-container">
                        <div className="user-profile-card__img">
                          <img src="/images/post-images/post-img-1.png" alt="Discover Profile Avatar" />
                        </div>
    ...
    <div className={`modal ${open ? "show" : ""}`} role="dialog" aria-modal="true">
     <div className="modal-wrap video_modal">
      ...
      <Plyr options={{controls: ["play-large", "play", "progress", "current-time", "mute", "fullscreen"],}} source={{ type: "video", sources: [{src: "https://res.cloudinary.com/drhj03nvv/video/upload/v1770026049/posts/69807440e60b526caa6da50c/1770026048286-screen-capture.webm.mkv", type: "video/mp4",},],}}/>
     </div>
    </div>
   </>
  );
