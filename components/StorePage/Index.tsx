...
const StorePage = () => {
  ...
  const [subActiveTab, setSubActiveTab] = useState<"all" | "videos" | "photos">(
    "all",
  );
  ...
  const renderPagination = () => {
    ...
    return (
      <div className="pagination_wrap">
        ...
        <button
          className="btn-prev"
          disabled={page === 1 || loadingPaidPosts}
          onClick={() => {
            if (!loadingPaidPosts) setPage(page - 1);
          }}
        >
          <ChevronLeft size={18} />
        </button>
        ...
        <button
          className="btn-next"
          disabled={page === totalPages || loadingPaidPosts}
          onClick={() => {
            if (!loadingPaidPosts) setPage(page + 1);
          }}
        >
