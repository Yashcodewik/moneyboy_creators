      ...
      <div className="moneyboy-2x-1x-a-layout">
        <div className="moneyboy-feed-page-container moneyboy-diff-content-wrappers">
          <div className="moneyboy-feed-page-cate-buttons card" id="posts-tabs-btn-card">
            {isCreator && (<button className={`page-content-type-button active-down-effect ${activeMainTab === "mystore" ? "active" : ""}`} onClick={() => setActiveMainTab("mystore")}> <span className="flex items-end justify-center"><img src="/images/logo/profile-badge.png" alt="M Icons" className="max-w-22"/>y Store</span></button>)}
            <button className={`page-content-type-button active-down-effect ${activeMainTab === "moneyboys" ? "active" : "" }`} onClick={() => setActiveMainTab("moneyboys")}>Moneyboys</button>
          </div>
