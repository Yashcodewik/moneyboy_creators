...
const StorePage = () => {
  ...
  useEffect(() => {
    dispatch(fetchAllCreators({ page: 1 }));
  }, [dispatch]);
        ...
        <div className="moneyboy-2x-1x-a-layout">
          <div className="moneyboy-feed-page-container moneyboy-diff-content-wrappers">
            <div className="moneyboy-feed-page-cate-buttons card" id="posts-tabs-btn-card">
              {isCreator && (
                <button className={`page-content-type-button active-down-effect ${activeMainTab === "mystore" ? "active" : ""}`} onClick={() => setActiveMainTab("mystore")}>
                  {" "}
                        ...
                        <div className="profile-card__main">
                          ...
                          <div className="profile-card__info">
                            <div className="profile-card__name-badge">
                              <div className="profile-card__name">{session?.user?.displayName || "—"}</div>
                              <div className="profile-card__badge">
                                <img src="/images/logo/profile-badge.png" alt="MoneyBoy Social Profile Badge"/>
                              </div>
                            </div>
                            <div className="profile-card__username">@{session?.user?.userName || "—"}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="hero-type-card-wrapper">
                  <div className="hero-type-card-container">
                    <div className="hero-type-card--bg-img">
                      <img src="/images/profile-banners/profile-banner-10.jpg" alt="Store Banner Image"/>
                    </div>
                    ...
                    <div className="hero-type-card--content-container">
                      ...
                      <div className="hero-type-card--cta-box">
                        ...
                        <div>
                          <button className="btn-txt-gradient btn-outline p-sm"><span>Request PPV</span></button>
                        </div>
                      </div>
                        ...
                        <div className="creator-content-cards-wrapper multi-dem-cards-wrapper-layout" data-layout-toggle-rows={layout === "list" ? true : undefined } >
                          {subActiveTab === "videos" && (
                            <div className="creator-content-type-container-wrapper" data-multi-tabs-content-tabdata__active>
                              {loadingPaidPosts && (<div className="loadingtext">{"Loading".split("").map((char, i) => (<span key={i} style={{animationDelay: `${(i + 1) * 0.1}s`,}}>{char}</span>))}</div>)}
                  ...
                  <div className="st_head">
                    <div className="head_text">
                      <h5 className="flex items-end justify-center">
                        <img src="/images/logo/profile-badge.png" alt="M Icons" className="max-w-22" /> Creators
                      </h5>
