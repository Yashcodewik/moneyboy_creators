...
//   setPage(1);
//   setHasMore(true);
// }, [search, time, subActiveTab, activeStoreOwner?.publicId]);
...
//     const totalPages = res?.payload?.pagination?.totalPages || 1;

//     if (page >= totalPages) {
//       setHasMore(false);
//     }
//   });
// }, [page, search, time, subActiveTab, activeStoreOwner?.publicId]);
// useEffect(() => {
//   const handleScroll = () => {
...
//     if (
//       scrollTop + windowHeight >= height - 150 &&
//       !loadingMore &&
//       hasMore
//     ) {
//       setLoadingMore(true);
