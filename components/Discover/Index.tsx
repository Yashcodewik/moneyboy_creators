          ...
          <div className="discovery-page-content-container">
            ...
            <div className="discovery-page-content-wrapper">
              <div className="discovery-page-cards-layouts">
                {loading && (
                  <div className="loadingtext grid-span-4">
                      ...
                      <div key={creator.creatorUserId} className="user-profile-card-wrapper" data-creator-profile-card onClick={() => handleProfileClick(creator.userName)}>
                        <div className="user-profile-card-container">
                          <div className="user-profile-card__img">
                            {creator.profile ? (
                              <img src={creator.profile} alt={creator.displayName} />
                            ) : (<NoProfileSvg />)}
                          </div>
                          <div className="user-profile-content-overlay-container">
                            ...
                            <div className="user-profile-card__info-container text_iconset gap-5">
                              ...
                              <div className="btntooltip_wrapper">
                                <button data-tooltip="Wishlist" className={`user-profile-card__wishlist-btn ${isSaved ? "active" : ""}`} onClick={(e) => { e.stopPropagation(); isSaved ? handleUnsaveCreator(creator.creatorUserId) : handleSaveCreator(creator.creatorUserId); }}>
