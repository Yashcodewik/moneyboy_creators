            ...
            {showVideo && selectedVideoUrl && (
              <div className="video_wrap">
                ...
                <div className="posterimg">
                 <img src="/images/post-images/post-img-3.png" alt="Post Images" className="posterimg"/>
                </div>
                ...
                {selectedItem && (
                        ...
                        <div className="profile-card__avatar-settings">
                          <div className="profile-card__avatar">
                            {selectedItem?.creator?.profile ? (
                              <img src={selectedItem.creator.profile} alt={selectedItem.creator.displayName || "profile"}/>
                            ) : (
                  ...
                  <div className="pm-page-card-footer vdocard-footer description">
                    <p className="lineclamp4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                  </div>
                  </>
                )}
              </div>
