...
import { FaEye, FaThumbsUp, FaThumbsDown, FaHeart, FaCommentAlt, FaFlag} from "react-icons/fa";
          ...
          <div className="pm-page-content-wrapper">
            <div className="pm-page-content-container">
              ...
              <div className="video_wrap">
               <iframe className="video_fream" src="https://www.youtube.com/embed/VIDEO_ID" title="Video player" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen />
               <div className="pm-page-card-footer vdocard-footer">
                  ...
                  <div className="meta-bar">
                    <div className="meta-item view"><FaEye /> <span>12K</span>
                    </div>
                    <div className="meta-item"><span>4 days ago</span></div>
                    <div className="meta-actions">
                      <Link href="#"><FaThumbsUp /> <span>71</span></Link>
                      <Link href="#"> <FaThumbsDown /></Link>
                      <Link href="#" className="favorite"><FaHeart /> <span>Favorite</span></Link>
                      <Link href="#"> <FaCommentAlt /> <span>4</span> </Link>
                      <Link href="#"><FaFlag /></Link>
                    </div>
                  </div>
                </div>
              </div>
