<div className= "moneyboy-2x-1x-layout-container" >
        <div className="moneyboy-2x-1x-a-layout" >
            <div className="moneyboy-feed-page-container" data - multiple - tabs - section data - scroll - zero >
                <div className="moneyboy-feed-page-cate-buttons card" id = "posts-tabs-btn-card" >
                    <button className={`page-content-type-button active-down-effect ${activeTab === "posts" ? "active" : ""}`
    }
    ...
    < button
className = {`page-content-type-button active-down-effect ${activeTab === "videos" ? "active" : ""
    }`}
onClick = {() => handleTabClick("videos")}
    ...
    < button
className = {`page-content-type-button active-down-effect ${activeTab === "photos" ? "active" : ""
    }`}
    ...
    < div className = "profile-card__username" >
        ...
        < div className = "moneyboy-post__upload-more-info" >
            <div className="moneyboy-post__upload-time" >
                ...
                < div
className = {`rel-user-more-opts-wrapper ${openMenuId === index ? "active" : ""
    }`}
                            ...
                            <div className="moneyboy-post__upload-time" >
                                ...
                                < div className = "moneyboy-post__desc" >
                                    ...
                                    < div className = "like-deslike-wrap" >
                                        <ul>
                                        <li>
                                        <Link href="#" className = {`comment-like-btn ${topComment.isLiked ? "active" : ""}`
} onClick = {(e) => { e.preventDefault(); dispatch(likeComment({ commentId: topComment._id, }),); }}>
...

{
    ...
    data - multi - dem - cards - layout - btns
        ...
        < button
    className = {`creator-content-grid-layout-btn ${gridLayoutMode.videos === "grid"
            ? "active"
            : "inactive"
        }`
}
...
fill = "none"
    ...
    < button
className = {`creator-content-grid-layout-btn ${gridLayoutMode.videos === "list"
        ? "active"
        : "inactive"
    }`}
onClick = {() =>
...
strokeLinejoin = "round"
    ...
    < div
className = {`creator-content-cards-wrapper multi-dem-cards-wrapper-layout ${gridLayoutMode.videos === "list"
        ? "list-view-layout"
        : ""
    } ${gridLayoutMode.videos === "grid"
        ? "grid-view-layout"
          ...
          )}
{
    ...
    data - multi - dem - cards - layout - btns
        ...
        {/* data__active */ }
        < button
    className = {`creator-content-grid-layout-btn ${gridLayoutMode.photos === "grid"
            ? "active"
            : "inactive"
        }`
}
...
fill = "none"
    ...
    < button
className = {`creator-content-grid-layout-btn ${gridLayoutMode.photos === "list"
        ? "active"
        : "inactive"
    }`}
onClick = {() =>
...
fill = "none"
    ...
    <path d="M19.9 13.5H4.1C2.6 13.5 2 14.14 2 15.73V19.77C2 21.36 2.6 22 4.1 22H19.9C21.4 22 22 21.36 22 19.77V15.73C22 14.14 21.4 13.5 19.9 13.5Z" />
        <path d="M19.9 2H4.1C2.6 2 2 2.64 2 4.23V8.27C2 9.86 2.6 10.5 4.1 10.5H19.9C21.4 10.5 22 9.86 22 8.27V4.23C22 2.64 21.4 2 19.9 2Z" />
            ...
            < div
className = {`creator-content-cards-wrapper multi-dem-cards-wrapper-layout ${gridLayoutMode.photos === "list"
        ? "list-view-layout"
        : ""
