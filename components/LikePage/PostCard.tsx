...
// /* ===================== TYPES ===================== */
// export interface PostUser {name: string; username: string; avatar: string; badge?: string;}
// export interface PostMedia {type: "image" | "video"; url: string;}
// export interface Post {id: string; user: PostUser; description: string; createdAt: string; media: PostMedia[]; likes: number; comments: number; isLiked: boolean; isSaved: boolean;}
...
//             <div className="profile-card__info">
//               <div className="profile-card__name-badge">
//                 <div className="profile-card__name">{post.user.name}</div>
...
//               </div>
//               <div className="profile-card__username">@{post.user.username}</div>
//             </div>
//           </div>
//         </Link>

//         <div className="moneyboy-post__upload-more-info">
//           <div className="moneyboy-post__upload-time">{post.createdAt}</div>
...
//               <div className="rel-users-more-opts-popup-container">
//                 <ul>
//                   <li data-copy-post-link="inset-post-link-here" onClick={handleCopy}>
//                     <div className="icon copy-link-icon">
...
//       <div className="moneyboy-post__desc">
//         <p> {post.description} <span className="active-down-effect-2x" onClick={(e) => {e.stopPropagation(); console.log("More clicked");}}>more</span></p>
//       </div>
...
//                 ) : (
//                   <Plyr source={{ type: "video", sources: [{ src: item.url, type: "video/mp4" }],}} options={{controls: ["play", "progress", "current-time", "mute", "volume", "fullscreen",],}}/>
//                 )}
//               </SwiperSlide>
//             ))}
//           </Swiper>
...
//             <li>
//               <Link href="#" className={`post-like-btn ${liked ? "active" : ""}`} onClick={handleLike}>
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
//           </li>
//             <li>
//               <Link href="#" onClick={() => setShowComments((p) => !p)}>
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
//           <ul>
//             <li>
//               <Link href="#" onClick={() => setShowReportModal(true)}>
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
//             <li>
//               <Link href="#" className={`post-save-btn ${saved ? "active" : ""}`} onClick={() => setSaved((p) => !p)}>
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
//             </li>
//           </ul>
//             <button className="btn-primary active-down-effect-2x">See more <ArrowUpRight size={14}/></button>
//         </div>
//       </div>
//      </div>
//     )}
//     {/* ========== Report Modal Start ========== */}
//     <div className={`modal ${showReportModal ? "show" : ""}`} role="dialog" aria-modal="true" aria-labelledby="age-modal-title" >
//       <div className="modal-wrap report-modal">
//         <button className="close-btn" onClick={() => setShowReportModal(false)}><CgClose size={22} /></button>
...
//             <SwiperSlide ><Plyr source={{ type: "video", sources: [{ src: "https://res.cloudinary.com/drhj03nvv/video/upload/v1770188682/posts/6982ef7e3bf4bec3e275778b/1770188670639-4945133-uhd_4096_2160_24fps.mp4.mp4", type: "video/mp4" }], }} options={{controls: ["play", "progress", "current-time", "mute", "volume", "fullscreen",],}}/></SwiperSlide>
//           </Swiper>
//           {/* <img src="/images/post-images/post-img-6.jpg" alt="MoneyBoy Post Image"/> */}
//         </div>
//         <div className="moneyboy-post__actions">
...
//             <li>
//               <Link href="#" className={`post-like-btn ${liked ? "active" : ""}`} onClick={() => {setLiked((prev) => !prev); setLikeCount((count) => (liked ? count - 1 : count + 1));}}>
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
//                   <path d="M12.62 20.81C12.28 20.93 11.72 20.93 11.38 20.81C8.48 19.82 2 15.69 2 8.68998C2 5.59998 4.49 3.09998 7.56 3.09998C9.38 3.09998 10.99 3.97998 12 5.33998C13.01 3.97998 14.63 3.09998 16.44 3.09998C19.51 3.09998 22 5.59998 22 8.68998C22 15.69 15.52 19.82 12.62 20.81Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
//                 </svg>
//                 <span>{likeCount >= 1000 ? `${(likeCount / 1000).toFixed(1)}K` : likeCount}</span>
...
//           </li>
//             <li>
//               <Link href="#" onClick={() => setShowComments((prev) => !prev)}>
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
//                   <path d="M8.5 19H8C4 19 2 18 2 13V8C2 4 4 2 8 2H16C20 2 22 4 22 8V13C22 17 20 19 16 19H15.5C15.19 19 14.89 19.15 14.7 19.4L13.2 21.4C12.54 22.28 11.46 22.28 10.8 21.4L9.3 19.4C9.14 19.18 8.77 19 8.5 19Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
//                   <path d="M7 8H17" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
//                   <path d="M7 13H13" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
...
//             <li>
//               <Link href="#" className={`post-save-btn ${saved ? "active" : ""}`} onClick={() => setSaved((prev) => !prev)}>
//                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
//                   <path d="M16.8199 2H7.17995C5.04995 2 3.31995 3.74 3.31995 5.86V19.95C3.31995 21.75 4.60995 22.51 6.18995 21.64L11.0699 18.93C11.5899 18.64 12.4299 18.64 12.9399 18.93L17.8199 21.64C19.3999 22.52 20.6899 21.76 20.6899 19.95V5.86C20.6799 3.74 18.9499 2 16.8199 2Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
//                   <path d="M16.8199 2H7.17995C5.04995 2 3.31995 3.74 3.31995 5.86V19.95C3.31995 21.75 4.60995 22.51 6.18995 21.64L11.0699 18.93C11.5899 18.64 12.4299 18.64 12.9399 18.93L17.8199 21.64C19.3999 22.52 20.6899 21.76 20.6899 19.95V5.86C20.6799 3.74 18.9499 2 16.8199 2Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
//                   <path d="M9.25 9.04999C11.03 9.69999 12.97 9.69999 14.75 9.04999" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
