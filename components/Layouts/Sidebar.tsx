                ...
                <div className="profile-card">
                  <a href="#" className="profile-card__main">
                    <div className="profile-card__avatar-settings">
                      ...
                      <div
                        className="profile-card__settings active-down-effect-2x"
                        onClick={(e) => {
                          if (session?.user?.role === 1) {
                ...
                <div className="sidebar-post-button card active-down-effect">
                  <a href="#" className="btn-primary" onClick={() => setAddFeedShow(true)}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M22 12V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22H12" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M20.96 17.84L19.33 18.39C18.88 18.54 18.52 18.89 18.37 19.35L17.82 20.98C17.35 22.39 15.37 22.36 14.93 20.95L13.08 15C12.72 13.82 13.81 12.72 14.98 13.09L20.94 14.94C22.34 15.38 22.36 17.37 20.96 17.84Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
              ...
              <ul>
                ...
                <li>
                  <Link
                    ...
                    onClick={(e) =>
                      handleMobileNavClick("discover", "/discover", e)
                    }
                  >
                    <div>
                      <svg
        ...
        <div className="modal-wrap creators-modal">
          <button className="close-btn"><CgClose size={22}/></button>
           ...
           <div className="label-input search_wrap">
             ...
             <input className="form-input" type="text" placeholder="Enter Keywords Here" name="city" />
           </div>
           <div className="actions">
             <button className="premium-btn"><span>Tag user</span></button>
             <button className="cate-back-btn active-down-effect">Release from</button>
           </div>
              ...
              <div className="profile-card__main">
                <div className="profile-card__avatar-settings">
                  <div className="profile-card__avatar">
                    <img alt="MoneyBoy Social Profile Avatar" src="/images/profile-avatars/profile-avatar-1.png" />
                  </div>
                </div>
                <div className="profile-card__info">
                  <div className="profile-card__name-badge">
                    <div className="profile-card__name">Marcus Botosh</div>
                    <div className="profile-card__badge">
                      <img alt="MoneyBoy Social Profile Badge" src="/images/logo/profile-badge.png" />
                    </div>
                  </div>
                  <div className="profile-card__username">@marcusbotosh</div>
                </div>
              </div>
            </div>
          ...
          <div className="creators-footer">
            <Link href="#" className="invite">+ Invite New User</Link>
