                  ...
                  <div className="h-full menu_cont">
                    ...
                    {isMenuOpen && (
                      <div className="menu_drop">
                        <ul>
                          <li>
                            <Link href="#" className="menu-link subscriptions_icons" onClick={(e) => { e.preventDefault(); if (session?.user?.role === 2) { handleNavClick("subscriptions", "/subscriptions", e); } else if (session?.user?.role === 1) { handleNavClick("subscriptions", "/subscriptions", e); } setIsMenuOpen(false); }}>
