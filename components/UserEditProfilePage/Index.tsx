            ...
            <div className="creator-profile-front-content-container">
              ...
              <div className="creator-profile-card-container card">
                <div className="creator-profile-banner">
                  <img src="/images/profile-banners/profile-banner-10.png" alt="Creator Profile Banner Image" />
                      ...
                      <div className="profile-card__main">
                        <div className="profile-card__avatar-settings">
                          <div className="profile-card__avatar">
                            <img src="/images/profile-avatars/profile-avatar-13.jpg" alt="MoneyBoy Social Profile Avatar"/>
                            <div className="imgicons"><TbCamera size="16" /></div>
                          </div>
                        </div>
                      </div>
