      ...
      <div className="moneyboy-2x-1x-a-layout wishlist-page-container">
        <div className="moneyboy-feed-page-container">
          <div className="moneyboy-feed-page-cate-buttons card" id="posts-tabs-btn-card">
            ...
            <button className="page-content-type-button active-down-effect active max-w-50">Post Details</button>
          </div>
                  ...
                  <div className="profile-card__main">
                    <div className="profile-card__avatar-settings">
                      <div className="profile-card__avatar">
                        {post?.creatorInfo?.profile?.trim() ? (
                          <img src={post.creatorInfo.profile} alt={post?.creatorInfo?.displayName || "Profile Avatar"} onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
                        ) : (
                          <div className="noprofile">
                            <svg width="40" height="40" viewBox="0 0 66 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <defs> <linearGradient id="paint0_linear_4470_53804" x1="0" y1="27" x2="66" y2="27" gradientUnits="userSpaceOnUse">
                    ...
                    <div className="profile-card__info">
                      <div className="profile-card__name-badge">
                        <div className="profile-card__name">{post.creatorInfo?.displayName || "User"}</div>
                        <div className="profile-card__badge">
                          <img src="/images/logo/profile-badge.png" alt="MoneyBoy Social Profile Badge"/>
                        </div>
                      </div>
                      <div className="profile-card__username">@{post.creatorInfo?.userName || "username"}</div>
                    </div>
                  </div>
                </a>
