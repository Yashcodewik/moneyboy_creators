...
import { muteThread, hideThread, searchMessages, toggleBlockThread, fetchThreadDetails, fetchSidebar,} from "@/redux/message/messageActions";
const ChatFeatures = ({
  threadPublicId,
  onSearch,
  onReport,
        ...
        <li onClick={onDelete}>
          <div className="icon delete-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <defs>
                <clipPath id="clip0_6001_200"><rect width="24" height="24" fill="white"></rect></clipPath>
              </defs>
            </svg>
          </div>
