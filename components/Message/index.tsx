                      ...
                      <div className="chat-room-body-layout">
                        <div className="chat-room-body-container">
                          ...
                          <div className="chat-msg-wrapper outcoming-message">
                            <div className="chat-msg-profile">
                              <img src="/images/profile-avatars/profile-avatar-13.jpg" alt="#"/>
                            </div>
                            <div className="chat-msg-txt-wrapper">
                              <div className="chat-msg-txt">
                                <p>Do androids truly dream of electric sheeps?</p>
                              </div>
                              <div className="chat-msg-details">
                                <div className="chat-msg-time">
                                  <span>12:30</span>
                          ...
                          <div className="chat-msg-wrapper incoming-message">
                            ...
                            <div className="chat-msg-txt-wrapper">
                              <div className="chat-msg-image">
                                <img src="/images/shared-media/image-1.jpg" alt="#"/>
                              </div>
                              <div className="chat-msg-details">
                                <div className="chat-msg-time">
                                  <span>12:30</span>
                          ...
                          <div className="chat-msg-wrapper incoming-message">
                            ...
                            <div className="chat-msg-txt-wrapper">
                              <div className="chat-msg-image">
                              <Plyr source={{type: "video", poster: "https://res.cloudinary.com/drhj03nvv/video/upload/so_1/posts/6982ef7e3bf4bec3e275778b/1770188670639-4945133-uhd_4096_2160_24fps.jpg",
                                sources: [{ src: "https://res.cloudinary.com/drhj03nvv/video/upload/v1770188682/posts/6982ef7e3bf4bec3e275778b/1770188670639-4945133-uhd_4096_2160_24fps.mp4.mp4", type: "video/mp4" }],
                              }}
                          ...
                          <div className="ppvrequest_wrap">
                            ...
                            <CustomSelect className="bg-white" label="Reason for Decline" searchable={false}
                              options={[{label: "Not Interested", value: "not_interested"}, {label: "Price Too High", value: "price_too_high"}, {label: "Content Not Relevant", value: "content_not_relevant"}, {label: "Already Purchased Similar Content", value: "already_purchased"}, {label: "Quality Concerns", value: "quality_concerns"}, {label: "Other", value: "other" },]}/>
                      ...
                      <div className="chat-room-footer-layout">
                        <div className="chat-room-footer-container">
                          ...
                          <div className="chat-msg-typing-input">
                            <input type="text" placeholder="Send a message..." value={newComment} onChange={(e) => setNewComment(e.target.value)}/>
                          </div>
