      ...
      <div className="moneyboy-2x-1x-a-layout wishlist-page-container">
        <div className="moneyboy-feed-page-container">
          ...
          <div className="moneyboy-posts-wrapper">
            ...
            <div className="moneyboy-comment-wrap">
              <div className="comment-wrap">
                <div className="label-input">
                  ...
                  <div className="input-placeholder-icon"> <i className="icons emojiSmile svg-icon"></i> </div>
                </div>
              </div>
            ...
            {/* ================= User Like And DesLike And Replay ================= */}
            <div className="moneyboy-post__container card gap-15">
              <div className="moneyboy-post__header">
                <a href="#" className="profile-card">
                  <div className="profile-card__main">
                    <div className="profile-card__avatar-settings">
                      <div className="profile-card__avatar">
                        <img src="/images/profile-avatars/profile-avatar-2.jpg" alt="MoneyBoy Social Profile Avatar" />
                      </div>
                    </div>
                    <div className="profile-card__info">
                      <div className="profile-card__name-badge">
              ...
              <div className="moneyboy-post__desc">
                <p>Lovely smile <img src="/images/icons/smiling-faceicons.svg" className="icons"/>
                  {/* <span className="active-down-effect-2x">more</span> */}
                </p>
              </div>
